package app.kitsune.integrations.shared.settings;
...
public abstract class Setting<T> {
    ...
    public static String exportToJson(@Nullable Context alertDialogContext) {
        try {
            ...
            if (alertDialogContext != null) {
                app.kitsune.integrations.youtube.sponsorblock.SponsorBlockSettings.showExportWarningIfNeeded(alertDialogContext);
            }
    ...
    public static boolean importFromJSON(@NonNull String settingsJsonString, boolean isYouTube) {
        try {
            ...
            if (isYouTube) {
                app.kitsune.integrations.youtube.sponsorblock.SponsorBlockSettings.updateFromImportedSettings();
            } else {
                app.kitsune.integrations.music.sponsorblock.SponsorBlockSettings.updateFromImportedSettings();
            }
